...
public class ViewImageAllEventViewPagerFragment extends Fragment {
    ...
    public ViewImageAllEventViewPagerFragment() {
    ...
    public static void loadViewPagerViewImage() {
        ...
        if(viewImageShared != null){
            ...
            //Lưu ý: Ở đây dùng ViewPagerAdapter giống hệt nhưng vẫn là fragment khác so với bên ViewImageEvent vì nếu dùng chung vẫn bị lag (không download ảnh được lần đầu tiên)
            ViewImageAllEventFragmentViewPagerAdapter adapter = new ViewImageAllEventFragmentViewPagerAdapter((FragmentActivity) view.getContext(), imageEventArrayList);
...
//        truyVanDuLieuSQLite.DeleteOneImageEvent(id_image_event);
        ...
        if(imageEventArrayList.isEmpty()){
            ...
            //Trả về update event (của menu View All Event)
            ViewAllEventViewPagerFragment.setCurrentItemCalendarViewPager(1);
