...
/*
Hiện tại cho thấy: Phải tự cài InAppUpdate thì khi có bản phát hành mới thì người dùng mới thấy hiện update
 */
...
//        Toast.makeText(parentActivity, "An update has just been downloaded!", Toast.LENGTH_SHORT).show();
        Snackbar.make(
                parentActivity.findViewById(R.id.layout_main_activity), //id của layout sẽ sử dụng Snackbar (VD: MainActivity xml)
