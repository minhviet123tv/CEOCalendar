...
public class UpdateEventViewAllFragment extends Fragment implements EasyPermissions.PermissionCallbacks{
    ...
    public UpdateEventViewAllFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_update_event_view_all, container, false);
...
//        handler.postDelayed(() -> setImageEventAdapter(), 500);
    ...
    public static void loadDataForActivity() {
        ...
        //Kiểm tra isEmpty vì khi tạo không để null mà để trống "" (với trường hợp không đặt thời gian) | Có thể set thời gian cụ thể cho default dạng String
...
//        timePickerDialog.setTitle("Select time"); //Tiêu đề
    ...
    private void setImageEventAdapter() {
        ...
        ImageEventAdapter imageEventAdapter = new ImageEventAdapter(view.getContext(), imageEventArrayList, showIconDeleteOneImage, () -> {
            ...
            //A. Hàm thực hiện khi click icon Add (cuối list)
            //Thực hiện hàm xin quyền truy cập tự tạo -> Sau đó mở màn hình chọn ảnh
            ...
            //B. Hàm khi click item (chính là click vào ảnh) được khai báo trong adapter -> thông báo nếu đang edit, xem ảnh nếu đang view
            ...
            if(showIconDeleteOneImage){
                ...
                //Mở fragment view ảnh, load lại viewPager của fragment mở ra này (nếu không load lại thì sẽ hiện cái cũ)
                ViewAllEventViewPagerFragment.setCurrentItemCalendarViewPager(2); //0: All event, 1: Update event, 2: View full Image
                ViewImageAllEventViewPagerFragment.loadViewPagerViewImage();
